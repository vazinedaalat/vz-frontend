...
/** Rules tailored for دادخواست / اظهارنامه attachment uploads. */
export const DOCUMENT_FILE_RULE_SECTIONS: readonly CaseFileRuleSection[] = [
  {
    id: 'formats',
    title: 'فرمت و حجم مجاز',
    body: [
      'فرمت‌های مجاز: PDF، JPG، PNG، WEBP و ZIP.',
      'حداکثر حجم هر فایل ۱۰ مگابایت و حداکثر ۱۰ فایل در هر درخواست.',
      'ترجیحاً اسکن رنگی خوانا؛ از عکس تار یا ناقص خودداری کنید.',
    ],
  },
  {
    id: 'attachments',
    title: 'منضمات ضروری برای تنظیم سند',
    body: [
      'مدارک هویتی خواهان / اظهارکننده (کارت ملی و شناسنامه).',
      'اسناد مثبت خواسته: قرارداد، چک، سفته، مبایعه‌نامه، رای یا ابلاغ قبلی.',
      'در اظهارنامه: متن تعهد یا مطالبه و مدارک ابلاغ‌پذیر.',
      'در شکواییه: دلایل وقوع جرم و گزارش‌های مرتبط در صورت وجود.',
    ],
  },
  {
    id: 'privacy',
    title: 'محرمانگی و مسئولیت',
    body: [
      'مدارک صرفاً برای تنظیم اوراق توسط وکیل استفاده می‌شود و محرمانه است.',
      'از ارسال رمز بانکی، رمز پویا یا اطلاعات غیرمرتبط خودداری کنید.',
      'اصالت و صحت مدارک بر عهده ارسال‌کننده است.',
    ],
  },
  {
    id: 'legal',
    title: 'نکته حقوقی',
    body: [
      'طبق ماده ۵۱ آیین دادرسی مدنی، دادخواست باید مشخصات طرفین، اقامتگاه، خواسته، جهات و ادله را روشن کند.',
      'آپلود منضمات در این مرحله برای تنظیم پیش‌نویس است؛ ثبت نهایی در ثنا / دفاتر خدمات الکترونیک قضایی جداگانه انجام می‌شود.',
    ],
  },
]
